...
The *standalone/dist/dmm-tools/scripts* folder contains several *.bat* files that can make setting up your windows environment easier:
 ...
 - *associate_dat.bat* associates output files with .data extension with data plotting executable
